...
public class PermissionResource {
    ...
    public ResponseEntity<Permission> updatePermission(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, permission.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<Permission> partialUpdatePermission(
        ...
        return ResponseUtil.wrapOrNotFound(
            result,
            HeaderUtil.createEntityUpdateAlert(applicationName, false, ENTITY_NAME, permission.getId())
        );
    }
